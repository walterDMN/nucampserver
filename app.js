...
//app.use(cookieParser('12345-67890-09876-54321')); //Secret key for signed cookies
...
/*function auth(req, res, next) {
  ...
  if (!req.session.user) {
      ...
      if (user === 'admin' && pass === 'password') {
          ...
          //res.cookie('user', 'admin', {signed: true}); //Creates a 'user' and assigns it's name to 'admin' while also making it a signed cookie
           //with the key provided earlier
